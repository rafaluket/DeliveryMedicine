...
import com.deliveryFarmacy.persistence.dao.UserRepository;
import com.deliveryFarmacy.security.CustomRememberMeServices;
import com.deliveryFarmacy.security.google2fa.CustomAuthenticationProvider;
import com.deliveryFarmacy.security.google2fa.CustomWebAuthenticationDetailsSource;
import com.deliveryFarmacy.security.location.DifferentLocationChecker;
        ...
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            .authorizeHttpRequests(authz -> {
                authz.requestMatchers(HttpMethod.GET, "/roleHierarchy")
                    .hasRole("STAFF")
                    .requestMatchers("/login*", "/logout*", "/signin/**", "/signup/**", "/customLogin", "/user/registration*", "/registrationConfirm*", "/expiredAccount*", "/registration*", "/farmacia*", "/entrega*", "/badUser*", "/user/resendRegistrationToken*", "/forgetPassword*",
